...
Values
    ("2023-04-28", 45, "London Waterloo", "Stratford", 01, 10100),
    ("2023-04-30", 78, "London Victoria", "London Brigde", 02, 10200),
    ("2023-10-12", 55, "London Liverpool Street", "London Waterloo", 03, 10300),
    ("2023-10-20", 34, "Stratford", "London Victoria", 01, 10100),
    ("2023-09-05", 66, "London Brigde", "London Liverpool Street", 02, 10200);
...
-- There are only 5 stations => only 5 stations id for each specific one => no auto increment
